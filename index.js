...
const PREFIX = "s";
const HELP_IMAGE_URL = "https://cdn.discordapp.com/attachments/1530810108899233845/1535967481196453969/file_0000000004808211a3a74b96ae281da2.png?ex=6a79b0b0&is=6a785f30&hm=b133c50089e6dbebac857c1e543e52d477c15bf1c12b7c5c20e404e76f8e4327&";
...
function embed(title, description) {
  return new EmbedBuilder().setColor(yellowPink()).setTitle(title).setDescription(description || "Done.").setTimestamp().setImage(HELP_IMAGE_URL);
}
